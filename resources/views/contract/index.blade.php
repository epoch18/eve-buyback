...
<script type="text/javascript">
	$("#contracts-button").click(function () {
		var button     = $("#contracts-button");
		var buttonText = "{!! trans('buyback.buttons.update_contracts') !!}";

		button.prop('disabled', true);
		button.html('<span class="fa fa-spinner fa-spin"></span> ') + buttonText;
